...
\begin{entrylist}
	...
	{Development Department}
	{
		...
		\techlist{Python, JavaScript, FastAPI, Frappe, Postgres, AWS, SQL, HTML, Postman}
	}
	...
	{"Dinamic Systems Analysis" Research group}
	{
		...
		\techlist{Python, Keras, Tensorflow, Streamlit}
	}
	{Research}
...
\begin{minipage}[t]{0.45\textwidth}
	...
	\begin{minipage}[t]{\textwidth}
		...
		\hspace{7mm} \cvskill{HTML}{3}
		\hspace{7mm} \cvskill{CSS}{2}
		\vspace{2.5mm}
	\end{minipage}
	\vspace{8mm}
